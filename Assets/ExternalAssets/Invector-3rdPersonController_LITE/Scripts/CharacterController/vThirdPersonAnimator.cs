...
namespace Invector.vCharacterController
{
    public class vThirdPersonAnimator : vThirdPersonMotor
    {
        ...
        public virtual void UpdateAnimator()
        {
            ...
            animator.SetBool(vAnimatorParameters.IsMoving, isMoving);
            animator.SetBool(vAnimatorParameters.IsDefending, isDefending);
    ...
    public static partial class vAnimatorParameters
    {
        ...
        public static int StopDancing= Animator.StringToHash("StopDancing");
        public static int IsAttack= Animator.StringToHash("IsAttack");
        public static int IsDeath= Animator.StringToHash("IsDeath");
        public static int StartDance1= Animator.StringToHash("StartDance1");
        public static int StartDance2= Animator.StringToHash("StartDance2");
        public static int StartDance3= Animator.StringToHash("StartDance3");
        public static int StartDance4= Animator.StringToHash("StartDance4");
        public static int StartDefense = Animator.StringToHash("StartDefense");
